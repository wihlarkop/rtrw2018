...
urlpatterns = [
    ...
    path('ktp/update/<int:pk>', KtpUpdate.as_view(), name='update_ktp'),
    path('ktp/delete/<int:pk>', KtpDelete.as_view(), name='delete_ktp'),
    path('ktp/detail/<int:pk>', KtpDetail.as_view(), name='detail_ktp'),
    # kk route
    ...
    path('kk/update/<int:pk>', KkUpdate.as_view(), name='update_kk'),
    path('kk/delete/<int:pk>', KkDelete.as_view(), name='delete_kk'),
